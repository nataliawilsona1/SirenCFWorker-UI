...
const bugOptions = [
  ...
  { value: "ava.game.naver.com", label: "NAVER GAME" },
  { value: "graph.instagram.com", label: "INSTAGRAM GRAPH" },
  { value: "df.game.naver.com", label: "NAVER DF" },
  { value: "zoomgov.com", label: "ZOOMGOV" },
  { value: "quiz.int.vidio.com", label: "VIDIO QUIZ" }
];
